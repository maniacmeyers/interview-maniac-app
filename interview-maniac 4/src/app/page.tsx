...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--im-bg)' }}>
      <div
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p style={{ color: 'var(--im-text-subtle)' }}>
            AI-Powered Interview Coaching
          </p>
        </div>

        {/* Tab Buttons */}
        <div className="flex mb-6 rounded-lg p-1" style={{ backgroundColor: 'var(--im-bg)' }}>
          <button
        ...
        {/* Error Message */}
        {error && (
          <div className="mb-4 p-3 rounded-lg" style={{ backgroundColor: 'var(--im-danger)', color: 'white' }}>
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-2" style={{ color: 'var(--im-text)' }}>
              Email
            </label>
            <input
              type="email"
        ...
        <div className="my-6 flex items-center">
          <div className="flex-1 h-px" style={{ backgroundColor: 'var(--im-text-subtle)' }}></div>
          <span className="px-4 text-sm" style={{ color: 'var(--im-text-subtle)' }}>
            Or continue with
          </span>
          <div className="flex-1 h-px" style={{ backgroundColor: 'var(--im-text-subtle)' }}></div>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm" style={{ color: 'var(--im-text-subtle)' }}>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm mb-2" style={{ color: 'var(--im-text-subtle)' }}>
            ✨ Coming Soon: Full AI-Powered Interview Coaching
          </p>
          <div className="text-xs space-y-1" style={{ color: 'var(--im-text-subtle)' }}>
            <div>🤖 Gemini AI Story Generation</div>
            <div>🎤 Voice Recording & Analysis</div>
            <div>📊 Real-time Feedback & Scoring</div>
